...
- Search for **Azure AI Services** and select **Create**.
    ...
    <img width="550" alt="image" src="https://github.com/user-attachments/assets/c3154f0b-7ce4-49e1-bb01-48147b07a5ee" />
...
2. **Select the AI Service Category**:
   ...
   - Choose the appropriate category for the AI service you need:
     ...
     - **Document Intelligence**: For advanced document processing.
         ...
         <img width="550" alt="image" src="https://github.com/user-attachments/assets/e693c32a-50b5-40fb-9995-07df3d4a0952" />
